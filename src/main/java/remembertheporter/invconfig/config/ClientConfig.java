...
public class ClientConfig {
    ...
    public static void init(ForgeConfigSpec.Builder client) {
        ...
        maxSlotsInHotbarRow = client.comment("The maximal number of slots in a hotbar slot (0 = as many as fit the screen)").defineInRange("general.max_slots_in_hotbar_row", 18, 0, Integer.MAX_VALUE);
