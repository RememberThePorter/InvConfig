...
public class ServerConfig {
    ...
    public static void init(ForgeConfigSpec.Builder server) {
        inventorySlots = server.comment("DEPRECATED - DO NOT CHANGE").defineInRange("general.inventory_slots", 36, 0, 36);
        hotbarSlots = server.comment("DEPRECATED - DO NOT CHANGE").defineInRange("general.hotbar_slots", 9, 0, 36);
        ...
        offhandSlot = server.comment("Should the offhand slot be enabled?").define("general.offhand_slot", true);
        headSlot = server.comment("Should the head armor slot be enabled?").define("general.head_slot", true);
        chestSlot = server.comment("Should the chest armor slot be enabled?").define("general.chest_slot", true);
        legsSlot = server.comment("Should the legs armor slot slot be enabled?").define("general.legs_slot", true);
        feetSlot = server.comment("Should the feet armor slot slot be enabled?").define("general.feet_slot", true);
        craftingTLSlot = server.comment("Should the top left crafting slot be enabled?").define("general.crafting_top_left_slot", true);
        craftingTRSlot = server.comment("Should the top right crafting slot be enabled?").define("general.crafting_top_right_slot", true);
        craftingBLSlot = server.comment("Should the bottom left crafting slot be enabled?").define("general.crafting_bottom_left_slot", true);
        craftingBRSlot = server.comment("Should the bottom right crafting slot be enabled?").define("general.crafting_bottom_right_slot", true);
        ...
        indexing = server.comment("DEPRECATED - DO NOT CHANGE").defineEnum("general.indexing",Indexing.INVCONFIG,Indexing.values());
